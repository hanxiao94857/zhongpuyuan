...
$accessKey = getenv('MQTT_AK_ENV') ?: 'YOUR_ACCESS_KEY_HERE';
##此处填写阿里云帐号 SecretKey
$secretKey = getenv('MQTT_SK_ENV') ?: 'YOUR_SECRET_KEY_HERE';
## 接入点地址，购买实例后从控制台获取
$endPoint = 'post-cn-pj64hj59901.mqtt.aliyuncs.com';
##实例 ID，购买后从控制台获取
$instanceId = 'post-cn-pj64hj59901';
## MQTT Topic,其中第一级 Topic 需要在 MQTT 控制台提前申请
$topic = 'zhongpuyuan';
## MQTT 客户端ID 前缀， GroupID，需要在 MQTT 控制台申请
$groupId = 'GID_zhongpuyuan';
